...
import 'package:flutter_app_msu2/views/show_details_ui.dart';
import '../models/food_shop_ui.dart';
            ...
            child: ListView.separated(
              ...
              itemBuilder: (conttext, index) {
                return ListTile(
                  ...
                  subtitle: Text(
                    foodShop[index].facebook_fs.toString(),
                  ),
                  trailing: Icon(
                    Icons.arrow_right,
                  ),
